...
Upload a cookbook and let an AI model automatically identify individual recipes, extract their ingredients and instructions, find recipe images, calculate metadata, and apply tags. Review and edit the results in a web interface, then import the recipes you want directly into Tandoor via its API.
