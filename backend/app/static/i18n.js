...
const TRANSLATIONS = {
  de: {
    ...
    checkDuplicatesBtn: 'Auf Dubletten prüfen',
    checkingDuplicates: 'Wird geprüft …',
    duplicatesCheckFailed: 'Prüfung fehlgeschlagen',
    duplicatesModalTitle: 'Dubletten in Tandoor',
    duplicatesCategoryFood: 'Zutaten',
    duplicatesCategoryUnit: 'Einheiten',
    duplicatesCategoryKeyword: 'Tags',
    duplicatesNoneFound: 'Keine Groß-/Kleinschreibungs-Dubletten gefunden. 🎉',
    ...
    photosCount: '{n} Fotos',
    forceOcrLabel: 'OCR für jede Seite erzwingen',
    forceOcrHint: 'Nutze das, wenn der erkannte Text merkwürdig/falsch aussieht, obwohl das PDF eine Textebene hat',
  ...
  en: {
    ...
    checkDuplicatesBtn: 'Check for duplicates',
    checkingDuplicates: 'Checking …',
    duplicatesCheckFailed: 'Check failed',
    duplicatesModalTitle: 'Duplicate names in Tandoor',
    duplicatesCategoryFood: 'Ingredients',
    duplicatesCategoryUnit: 'Units',
    duplicatesCategoryKeyword: 'Tags',
    duplicatesNoneFound: 'No case-sensitivity duplicates found. 🎉',
    ...
    forceOcrLabel: 'Force OCR on every page',
    forceOcrHint: 'Use this if extracted text looks garbled or wrong even though the PDF has a text layer',
  ...
  fr: {
    ...
    checkDuplicatesBtn: 'Vérifier les doublons',
    checkingDuplicates: 'Vérification …',
    duplicatesCheckFailed: 'Échec de la vérification',
    duplicatesModalTitle: 'Noms en double dans Tandoor',
    duplicatesCategoryFood: 'Ingrédients',
    duplicatesCategoryUnit: 'Unités',
    duplicatesCategoryKeyword: 'Tags',
    duplicatesNoneFound: 'Aucun doublon de casse trouvé. 🎉',
    ...
    photosCount: '{n} photos',
    forceOcrLabel: 'Forcer l’OCR sur chaque page',
    forceOcrHint: 'Utile si le texte extrait semble incorrect même si le PDF contient une couche de texte',
  ...
  it: {
    ...
    checkDuplicatesBtn: 'Controlla duplicati',
    checkingDuplicates: 'Controllo in corso …',
    duplicatesCheckFailed: 'Controllo non riuscito',
    duplicatesModalTitle: 'Nomi duplicati in Tandoor',
    duplicatesCategoryFood: 'Ingredienti',
    duplicatesCategoryUnit: 'Unità',
    duplicatesCategoryKeyword: 'Tag',
    duplicatesNoneFound: 'Nessun duplicato di maiuscole/minuscole trovato. 🎉',
    ...
    photosCount: '{n} foto',
    forceOcrLabel: 'Forza OCR su ogni pagina',
    forceOcrHint: 'Usalo se il testo estratto sembra errato anche se il PDF ha uno strato di testo',
  ...
  es: {
    ...
    checkDuplicatesBtn: 'Buscar duplicados',
    checkingDuplicates: 'Comprobando …',
    duplicatesCheckFailed: 'Error en la comprobación',
    duplicatesModalTitle: 'Nombres duplicados en Tandoor',
    duplicatesCategoryFood: 'Ingredientes',
    duplicatesCategoryUnit: 'Unidades',
    duplicatesCategoryKeyword: 'Etiquetas',
    duplicatesNoneFound: 'No se encontraron duplicados de mayúsculas/minúsculas. 🎉',
    ...
    photosCount: '{n} fotos',
    forceOcrLabel: 'Forzar OCR en cada página',
    forceOcrHint: 'Úsalo si el texto extraído se ve raro o incorrecto aunque el PDF tenga una capa de texto',
